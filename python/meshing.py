...
'''
Computes the area of intersection between two triangle meshes (only works in 2D).
'''
def compute_intersecting_area(vs0, vs1, fs0, fs1):
    ...
    return polygons.compute_polygon_area(polygonpoints)